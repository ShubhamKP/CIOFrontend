...
@Component({
  selector: 'app-webinar-main',
  templateUrl: './webinar-main.component.html',
  styleUrls: ['./webinar-main.component.css'],
  providers: [ OpentokService ]
})
export class WebinarMainComponent implements OnInit {
